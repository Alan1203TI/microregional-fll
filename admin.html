...
<body>
  ...
  <main class="container" id="adminContent" style="display:none">
    <section class="card admin-control-card">
      ...
      <div class="admin-timer-control">
        <div>
          <h3>Cronômetro oficial</h3>
          <p class="muted">Controle aqui o cronômetro único exibido na aba Cronômetro.</p>
        </div>

        <div class="admin-big-timer" id="adminTimerDisplay">02:30</div>

        <div class="admin-actions-grid timer-actions">
          <button class="btn primary" id="adminStartTimer" type="button">Iniciar</button>
          <button class="btn" id="adminPauseTimer" type="button">Pausar</button>
          <button class="btn red" id="adminResetTimer" type="button">Reiniciar</button>
          <a class="btn green" href="cronometro.html" target="_blank">Abrir cronômetro</a>
        </div>

        <div class="judge-timer-status paused" id="adminTimerStatus">Parado</div>
      </div>
  ...
  <script type="module" src="admin.js?v=20260619-ajustes"></script>
</body>
</html>
