...
<button class="btn red full-btn" id="clearBtn">Limpar marcação</button>
  ...
  <script type="module" src="js/visual-settings.js?v=20260622-clean-v2"></script>
  <script type="module" src="js/app.js?v=20260622-clean-v2"></script>
</body>
</html>
